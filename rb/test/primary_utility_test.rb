...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = NexardaOmni.make_runner(TEST_JSON_FILE, NexardaSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : NexardaOmni.errify(err)
    end
