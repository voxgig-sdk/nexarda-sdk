...
module NexardaTestRunner
  ...
  def self.env_override(m)
    live = getenv("NEXARDA_TEST_LIVE")
    override = getenv("NEXARDA_TEST_OVERRIDE")
    ...
    explain = getenv("NEXARDA_TEST_EXPLAIN")
    m["NEXARDA_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = NexardaTestRunner
Helpers = NexardaHelpers
Vs = VoxgigStruct
