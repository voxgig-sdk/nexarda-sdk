...
class PriceEntity
  ...
  #
  # @param reqmatch [PriceListMatch, Hash, nil] match filter (any subset of
  #   Price fields); defaults to nil, treated as an empty match that lists all.
