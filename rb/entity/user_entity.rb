...
class UserEntity
  ...
  # @return [User, Hash] the loaded User; raises NexardaError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<User>, Array] the matching User items; raises NexardaError on failure
