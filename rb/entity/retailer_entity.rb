...
class RetailerEntity
  ...
  def make
    opts = @_entopts.dup
    RetailerEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [RetailerListMatch, Hash, nil] match filter (any subset of
  #   Retailer fields); defaults to nil, treated as an empty match that lists all.
