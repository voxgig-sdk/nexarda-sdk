...
class StudioEntity
  ...
  #   as an empty match, so client.Studio.load works with no args).
  ...
  #
  # @param reqmatch [StudioListMatch, Hash, nil] match filter (any subset of
  #   Studio fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
