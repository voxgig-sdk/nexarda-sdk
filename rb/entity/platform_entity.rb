...
class PlatformEntity
  ...
  def make
    opts = @_entopts.dup
    PlatformEntity.new(@_client, opts)
  end
  ...
  # @return [Platform, Hash] the current Platform data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Platform fields)
  def match_get
  ...
  #
  # @param reqmatch [PlatformLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Platform.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Platform, Hash] the loaded Platform; raises NexardaError on failure
