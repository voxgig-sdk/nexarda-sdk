...
class NexardaTestRunner
{
    ...
    {
        $live = self::getenv('NEXARDA_TEST_LIVE');
        $override = self::getenv('NEXARDA_TEST_OVERRIDE');
        ...
        $explain = self::getenv('NEXARDA_TEST_EXPLAIN');
...
class_alias('NexardaTestRunner', 'Runner');
class_alias('NexardaHelpers', 'Helpers');
