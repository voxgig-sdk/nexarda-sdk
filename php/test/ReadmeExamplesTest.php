...
// Nexarda SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (NexardaSDK::test)
...
{
    private const SDK_CLASS = 'NexardaSDK';
    ...
    private const SDK_BASE = 'nexarda_sdk';
