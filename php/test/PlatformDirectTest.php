...
class PlatformDirectTest extends TestCase
{
    public function test_direct_load_platform(): void
    {
        $setup = platform_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-platform", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
