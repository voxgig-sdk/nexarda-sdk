...
class WidgetEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new WidgetEntity($this->_client, $opts);
    }

    /**
     * @param Widget|array $args Widget data (assoc-array) to store.
     */
    ...
    /**
     * @return Widget|array The current Widget data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Widget fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Widget fields).
     */
     ...
     *
     * @param WidgetLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed WidgetLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Widget|array The loaded Widget as an assoc-array at the
