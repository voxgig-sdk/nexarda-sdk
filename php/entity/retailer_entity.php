...
class RetailerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RetailerEntity($this->_client, $opts);
    }

    /**
     * @param Retailer|array $args Retailer data (assoc-array) to store.
     */
    ...
    /**
     * @return Retailer|array The current Retailer data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Retailer fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Retailer fields).
     */
     ...
     *
     * @param RetailerListMatch|array|null $reqmatch Match filter (any subset
     *   of Retailer fields) as an assoc-array; RetailerListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Retailer[]|array A list of Retailer items as assoc-arrays at
