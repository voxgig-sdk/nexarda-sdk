...
class StudioEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new StudioEntity($this->_client, $opts);
    }

    /**
     * @param Studio|array $args Studio data (assoc-array) to store.
     */
    ...
    /**
     * @return Studio|array The current Studio data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Studio fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Studio fields).
     */
     ...
     *
     * @param StudioLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed StudioLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Studio|array The loaded Studio as an assoc-array at the
     ...
     *
     * @param StudioListMatch|array|null $reqmatch Match filter (any subset
     *   of Studio fields) as an assoc-array; StudioListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Studio[]|array A list of Studio items as assoc-arrays at
