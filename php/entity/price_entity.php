...
class PriceEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PriceEntity($this->_client, $opts);
    }

    /**
     * @param Price|array $args Price data (assoc-array) to store.
     */
    ...
    /**
     * @return Price|array The current Price data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Price fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Price fields).
     */
     ...
     *
     * @param PriceListMatch|array|null $reqmatch Match filter (any subset
     *   of Price fields) as an assoc-array; PriceListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Price[]|array A list of Price items as assoc-arrays at
