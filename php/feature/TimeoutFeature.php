...
class NexardaTimeoutFeature extends NexardaBaseFeature
{
    ...
    private function _with_timeout(NexardaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(NexardaContext $_ctx, float $ms): void
    {
        $client = $this->client;
