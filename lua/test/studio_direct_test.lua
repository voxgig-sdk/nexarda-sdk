...
describe("StudioDirect", function()
  it("should direct-list-studio", function()
    local setup = studio_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-studio", setup.live and "live" or "unit")
  ...
  it("should direct-load-studio", function()
    local setup = studio_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-studio", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function studio_direct_setup(mockres)
