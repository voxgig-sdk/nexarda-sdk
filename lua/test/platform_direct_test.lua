...
describe("PlatformDirect", function()
  it("should direct-load-platform", function()
    local setup = platform_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-platform", setup.live and "live" or "unit")
...
function platform_direct_setup(mockres)
