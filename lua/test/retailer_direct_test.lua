...
describe("RetailerDirect", function()
  it("should direct-list-retailer", function()
    local setup = retailer_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-retailer", setup.live and "live" or "unit")
...
function retailer_direct_setup(mockres)
