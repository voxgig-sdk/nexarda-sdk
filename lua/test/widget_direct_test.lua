...
describe("WidgetDirect", function()
  it("should direct-load-widget", function()
    local setup = widget_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-widget", setup.live and "live" or "unit")
...
function widget_direct_setup(mockres)
