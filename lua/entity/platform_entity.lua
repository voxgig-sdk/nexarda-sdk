...
PlatformEntity.__index = PlatformEntity


function PlatformEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PlatformEntity)
  self._name = "platform"
  self._client = client
...
function PlatformEntity:get_name()
  return self._name
end


function PlatformEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PlatformEntity.new(self._client, opts)
end
...
function PlatformEntity:mark_deleted()
  self._deleted = true
end


function PlatformEntity:deleted()
  return true == self._deleted
end


function PlatformEntity:data_set(args)
  if args ~= nil then
...
function PlatformEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PlatformEntity:match_set(args)
  if args ~= nil then
...
function PlatformEntity:match_get()
...
function PlatformEntity:stream(action, args, callopts)
...
---@param reqmatch PlatformLoadMatch
---@param ctrl? table
---@return Platform
---@return string? err
function PlatformEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function PlatformEntity:_run_op(ctx, post_done)
  local utility = self._utility
