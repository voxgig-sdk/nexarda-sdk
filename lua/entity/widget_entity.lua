...
local WidgetEntity = {}
WidgetEntity.__index = WidgetEntity


function WidgetEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, WidgetEntity)
  self._name = "widget"
  self._client = client
...
function WidgetEntity:get_name()
  return self._name
end


function WidgetEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return WidgetEntity.new(self._client, opts)
end
...
function WidgetEntity:mark_deleted()
  self._deleted = true
end


function WidgetEntity:deleted()
  return true == self._deleted
end


function WidgetEntity:data_set(args)
  if args ~= nil then
...
function WidgetEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function WidgetEntity:match_set(args)
  if args ~= nil then
...
function WidgetEntity:match_get()
...
function WidgetEntity:stream(action, args, callopts)
...
function WidgetEntity:_run_op(ctx, post_done)
  local utility = self._utility
