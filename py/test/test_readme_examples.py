# Nexarda SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions NexardaSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both NexardaSDK(...) and NexardaSDK.test(...) become
#      NexardaSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "nexarda_sdk"
_SDK_CLASS = "NexardaSDK"
