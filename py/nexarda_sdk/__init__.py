...
from nexarda_sdk.utility import register

# Load features
from nexarda_sdk.feature.base_feature import NexardaBaseFeature
from nexarda_sdk.features import _has_feature, _make_feature
...
class NexardaSDK:
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "NexardaSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("NexardaSDK: graphql: " + str(msg))
            res["graphql"] = errors
