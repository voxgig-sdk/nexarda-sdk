...
func registerSDKWords(r *eng.Registry, client *sdk.NexardaSDK) {
...
func runOp(client *sdk.NexardaSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
