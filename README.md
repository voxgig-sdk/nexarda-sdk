...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/nexarda` | `npm install @voxgig-sdk/nexarda` |
| Python | `voxgig-sdk-nexarda` | `pip install voxgig-sdk-nexarda` |
| PHP | `voxgig-sdk/nexarda` | `composer require voxgig-sdk/nexarda` |
| Golang | `github.com/voxgig-sdk/nexarda-sdk/go` | `go get github.com/voxgig-sdk/nexarda-sdk/go` |
| Ruby | `voxgig-sdk-nexarda` | `gem install voxgig-sdk-nexarda` |
| Lua | `voxgig-sdk-nexarda` | `luarocks install voxgig-sdk-nexarda` |
