...
|---|---|---|
| `ts/` | @voxgig-sdk/nexarda-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/nexarda-sdk \
      --repository voxgig-sdk/nexarda-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/nexarda-sdk` shows it, and
`npm trust revoke @voxgig-sdk/nexarda-sdk --id=<id>` removes it.
