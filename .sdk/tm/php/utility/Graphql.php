...
class NexardaGraphql
{
    ...
    // equivalent.
    public static function body(NexardaContext $ctx): mixed
    {
    ...
    public static function errors(NexardaContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
