...
// Nexarda SDK utility: fetcher

class NexardaFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; NexardaSDK/1.0)';
    ...
    public static function call(NexardaContext $ctx, string $fullurl, array $fetchdef): array
    {
