...
class NexardaStreamingFeature extends NexardaBaseFeature
{
    ...
    private function _iterate(NexardaResult $result): \Generator
    {
    ...
    private function _streamable(NexardaContext $ctx): bool
    {
