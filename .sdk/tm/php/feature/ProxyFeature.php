...
class NexardaProxyFeature extends NexardaBaseFeature
{
    ...
    public function init(NexardaContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (NexardaContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
