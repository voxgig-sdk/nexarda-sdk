...
class NexardaNetsimFeature extends NexardaBaseFeature
{
    ...
    private function _simulate(NexardaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(NexardaContext $ctx, array $applied): void
    {
        $client = $this->client;
