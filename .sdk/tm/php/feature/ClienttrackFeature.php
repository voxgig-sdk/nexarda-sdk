...
// Nexarda SDK clienttrack feature
...
class NexardaClienttrackFeature extends NexardaBaseFeature
{
    ...
    public function PostConstruct(NexardaContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Nexarda-SDK';
