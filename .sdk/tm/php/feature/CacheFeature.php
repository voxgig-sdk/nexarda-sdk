...
class NexardaCacheFeature extends NexardaBaseFeature
{
    ...
    private function _through(NexardaContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
