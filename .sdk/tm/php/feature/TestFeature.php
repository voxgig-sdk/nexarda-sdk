...
// Nexarda SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class NexardaTestFeature extends NexardaBaseFeature
{
    ...
    public function init(NexardaContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (NexardaContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (NexardaContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(NexardaContext $ctx, $op, $args): array
    {
