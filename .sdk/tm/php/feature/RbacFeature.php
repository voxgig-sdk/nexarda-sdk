...
class NexardaRbacFeature extends NexardaBaseFeature
{
    ...
    private function _required(NexardaContext $ctx): ?string
    {
    ...
    private function _reject(NexardaContext $ctx, string $required): void
    {
    ...
    private function _track(NexardaContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
