...
class NexardaRatelimitFeature extends NexardaBaseFeature
{
    ...
    private function _acquire(NexardaContext $ctx): void
    {
    ...
    private function _track(NexardaContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
