...
{
    private static function utility(): NexardaUtility
    {
        return new NexardaUtility();
    }
    ...
    private static function ctx(array $over = []): NexardaContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new NexardaContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new NexardaOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof NexardaError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new NexardaOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = NexardaMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new NexardaOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = NexardaMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new NexardaOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = NexardaMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NexardaSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = NexardaMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new NexardaResponse([]),
            'result' => new NexardaResult([]),
        ]);
        [, $err] = NexardaMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new NexardaSpec([]),
            'response' => null,
            'result' => new NexardaResult([]),
        ]);
        [, $err] = NexardaMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new NexardaSpec(['step' => 's']),
            'response' => new NexardaResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new NexardaResult([]),
        ]);
        [, $err] = NexardaMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new NexardaSpec(['step' => 's']),
            'response' => new NexardaResponse(self::resp(200, ['v' => 1])),
            'result' => new NexardaResult([]),
        ]);
        [, $err] = NexardaMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new NexardaSpec(['step' => 's']),
            'response' => new NexardaResponse(self::resp(200, ['v' => 2])),
            'result' => new NexardaResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        NexardaMakeResponse::call($ctx);
    ...
    {
        $preset = new NexardaResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new NexardaSpec([]),
            'response' => new NexardaResponse([]),
            'result' => new NexardaResult([]),
        ...
        [$got, $err] = NexardaMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new NexardaResult([])]);
        [, $err] = NexardaMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new NexardaSpec([]), 'result' => null]);
        [, $err] = NexardaMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NexardaSpec(['step' => 's']),
            'result' => new NexardaResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new NexardaOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NexardaMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new NexardaSpec(['step' => 's']),
            'result' => new NexardaResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new NexardaOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = NexardaMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new NexardaResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new NexardaSpec([]),
            'result' => new NexardaResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = NexardaMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NexardaMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new NexardaError('boom', 'boom');
        $utility->fetcher = function (NexardaContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NexardaSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = NexardaMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (NexardaContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = NexardaMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(NexardaResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (NexardaContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new NexardaSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = NexardaMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new NexardaResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new NexardaSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = NexardaMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = NexardaMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = NexardaMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new NexardaResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, NexardaDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new NexardaResult(['ok' => false])]);
        $this->expectException(NexardaError::class);
        NexardaDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new NexardaResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', NexardaMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        NexardaMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new NexardaBaseFeature();
        $b = new NexardaBaseFeature();
        NexardaFeatureAdd::call($ctx, $a);
        NexardaFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): NexardaBaseFeature
    {
        $f = new NexardaBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        NexardaFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): NexardaContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new NexardaSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = NexardaPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new NexardaResponse(['headers' => null]),
            'result' => new NexardaResult([]),
        ]);
        NexardaResultHeaders::call($ctx);
