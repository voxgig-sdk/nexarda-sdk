...
// Nexarda SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = NexardaOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(NexardaOmni::structfix($now, Struct::undef()))
                        !== json_encode(NexardaOmni::structfix($val, Struct::undef()))) {
