...
class NexardaTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NexardaTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = NexardaTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = NexardaTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
