...
class NexardaTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = NexardaTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = NexardaTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = NexardaTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
