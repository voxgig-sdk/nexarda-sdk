...
from projectname_sdk import NexardaSDK
from projectname_sdk.core.spec import NexardaSpec
from projectname_sdk.core.result import NexardaResult
from projectname_sdk.core.response import NexardaResponse
from projectname_sdk.core.operation import NexardaOperation
from projectname_sdk.core.error import NexardaError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import NexardaBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = NexardaSDK.test(None, None)
        ...
        class TestInitFeature(NexardaBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(NexardaBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = NexardaSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = NexardaSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = NexardaSDK.test(None, setup_opts)
