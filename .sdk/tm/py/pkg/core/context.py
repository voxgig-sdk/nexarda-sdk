...
from projectname_sdk.core.control import NexardaControl
...
class NexardaContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, NexardaResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return NexardaError(code, msg, self)
