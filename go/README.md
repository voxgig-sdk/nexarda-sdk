...
## Install
```bash
go get github.com/voxgig-sdk/nexarda-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/nexarda-sdk=../path/to/github.com/voxgig-sdk/nexarda-sdk
```
...
```
github.com/voxgig-sdk/nexarda-sdk/
...
The root package (`github.com/voxgig-sdk/nexarda-sdk`) re-exports everything needed
