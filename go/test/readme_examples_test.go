...
const testSeed = `map[string]any{"entity": map[string]any{"console": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "franchis": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "game": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "platform": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "price": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "retailer": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "studio": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "widget": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
