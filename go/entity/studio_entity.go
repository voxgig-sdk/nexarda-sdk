...
func NewStudioEntity(client *core.NexardaSDK, entopts map[string]any) *StudioEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *StudioEntity) GetName() string { return e.name }
...
func (e *StudioEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *StudioEntity) Deleted() bool {
	return e.deleted
}


func (e *StudioEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewStudioEntity(e.client, opts)
}

func (e *StudioEntity) Data(args ...any) any {
...
func (e *StudioEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Studio; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *StudioEntity) DataTyped(data ...Studio) Studio {
	if len(data) > 0 {
		return typedFrom[Studio](e.Data(asMap(data[0])))
	}
	return typedFrom[Studio](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Studio (all fields
// optional at the wire level).
func (e *StudioEntity) MatchTyped(match ...Studio) Studio {
	if len(match) > 0 {
		return typedFrom[Studio](e.Match(asMap(match[0])))
	}
	return typedFrom[Studio](e.Match())
}
...
func (e *StudioEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *StudioEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// StudioLoadMatch and returns an Studio. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *StudioEntity) LoadTyped(reqmatch StudioLoadMatch, ctrl map[string]any) (Studio, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Studio{}, err
	}
	return typedFrom[Studio](res), nil
}




func (e *StudioEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// StudioListMatch and returns []Studio. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *StudioEntity) ListTyped(reqmatch StudioListMatch, ctrl map[string]any) ([]Studio, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Studio](res), nil
}



func (e *StudioEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *StudioEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *StudioEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *StudioEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
