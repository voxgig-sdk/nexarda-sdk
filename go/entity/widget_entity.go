...
func NewWidgetEntity(client *core.NexardaSDK, entopts map[string]any) *WidgetEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WidgetEntity) GetName() string { return e.name }
...
func (e *WidgetEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WidgetEntity) Deleted() bool {
	return e.deleted
}


func (e *WidgetEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWidgetEntity(e.client, opts)
}

func (e *WidgetEntity) Data(args ...any) any {
...
func (e *WidgetEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Widget; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *WidgetEntity) DataTyped(data ...Widget) Widget {
	if len(data) > 0 {
		return typedFrom[Widget](e.Data(asMap(data[0])))
	}
	return typedFrom[Widget](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Widget (all fields
// optional at the wire level).
func (e *WidgetEntity) MatchTyped(match ...Widget) Widget {
	if len(match) > 0 {
		return typedFrom[Widget](e.Match(asMap(match[0])))
	}
	return typedFrom[Widget](e.Match())
}
...
func (e *WidgetEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WidgetEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// WidgetLoadMatch and returns an Widget. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *WidgetEntity) LoadTyped(reqmatch WidgetLoadMatch, ctrl map[string]any) (Widget, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Widget{}, err
	}
	return typedFrom[Widget](res), nil
}



func (e *WidgetEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *WidgetEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *WidgetEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *WidgetEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *WidgetEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
