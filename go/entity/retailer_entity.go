...
func NewRetailerEntity(client *core.NexardaSDK, entopts map[string]any) *RetailerEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RetailerEntity) GetName() string { return e.name }
...
func (e *RetailerEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RetailerEntity) Deleted() bool {
	return e.deleted
}


func (e *RetailerEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRetailerEntity(e.client, opts)
}

func (e *RetailerEntity) Data(args ...any) any {
...
func (e *RetailerEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Retailer; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RetailerEntity) DataTyped(data ...Retailer) Retailer {
	if len(data) > 0 {
		return typedFrom[Retailer](e.Data(asMap(data[0])))
	}
	return typedFrom[Retailer](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Retailer (all fields
// optional at the wire level).
func (e *RetailerEntity) MatchTyped(match ...Retailer) Retailer {
	if len(match) > 0 {
		return typedFrom[Retailer](e.Match(asMap(match[0])))
	}
	return typedFrom[Retailer](e.Match())
}
...
func (e *RetailerEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RetailerEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *RetailerEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RetailerListMatch and returns []Retailer. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RetailerEntity) ListTyped(reqmatch RetailerListMatch, ctrl map[string]any) ([]Retailer, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Retailer](res), nil
}



func (e *RetailerEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RetailerEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RetailerEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RetailerEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
