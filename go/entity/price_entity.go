...
func NewPriceEntity(client *core.NexardaSDK, entopts map[string]any) *PriceEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PriceEntity) GetName() string { return e.name }
...
func (e *PriceEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PriceEntity) Deleted() bool {
	return e.deleted
}


func (e *PriceEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPriceEntity(e.client, opts)
}

func (e *PriceEntity) Data(args ...any) any {
...
func (e *PriceEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Price; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PriceEntity) DataTyped(data ...Price) Price {
	if len(data) > 0 {
		return typedFrom[Price](e.Data(asMap(data[0])))
	}
	return typedFrom[Price](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Price (all fields
// optional at the wire level).
func (e *PriceEntity) MatchTyped(match ...Price) Price {
	if len(match) > 0 {
		return typedFrom[Price](e.Match(asMap(match[0])))
	}
	return typedFrom[Price](e.Match())
}
...
func (e *PriceEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PriceEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PriceEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PriceListMatch and returns []Price. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PriceEntity) ListTyped(reqmatch PriceListMatch, ctrl map[string]any) ([]Price, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Price](res), nil
}



func (e *PriceEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PriceEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PriceEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PriceEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
