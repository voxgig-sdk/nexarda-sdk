...
func NewConsoleEntity(client *core.NexardaSDK, entopts map[string]any) *ConsoleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ConsoleEntity) GetName() string { return e.name }
...
func (e *ConsoleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ConsoleEntity) Deleted() bool {
	return e.deleted
}


func (e *ConsoleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewConsoleEntity(e.client, opts)
}

func (e *ConsoleEntity) Data(args ...any) any {
...
func (e *ConsoleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Console; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ConsoleEntity) DataTyped(data ...Console) Console {
	if len(data) > 0 {
		return typedFrom[Console](e.Data(asMap(data[0])))
	}
	return typedFrom[Console](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Console (all fields
// optional at the wire level).
func (e *ConsoleEntity) MatchTyped(match ...Console) Console {
	if len(match) > 0 {
		return typedFrom[Console](e.Match(asMap(match[0])))
	}
	return typedFrom[Console](e.Match())
}
...
func (e *ConsoleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ConsoleEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ConsoleLoadMatch and returns an Console. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ConsoleEntity) LoadTyped(reqmatch ConsoleLoadMatch, ctrl map[string]any) (Console, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Console{}, err
	}
	return typedFrom[Console](res), nil
}




func (e *ConsoleEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// ConsoleListMatch and returns []Console. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ConsoleEntity) ListTyped(reqmatch ConsoleListMatch, ctrl map[string]any) ([]Console, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Console](res), nil
}



func (e *ConsoleEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ConsoleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ConsoleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ConsoleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
