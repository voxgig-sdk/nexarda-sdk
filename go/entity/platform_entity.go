...
func NewPlatformEntity(client *core.NexardaSDK, entopts map[string]any) *PlatformEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PlatformEntity) GetName() string { return e.name }
...
func (e *PlatformEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PlatformEntity) Deleted() bool {
	return e.deleted
}


func (e *PlatformEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPlatformEntity(e.client, opts)
}

func (e *PlatformEntity) Data(args ...any) any {
...
func (e *PlatformEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Platform; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PlatformEntity) DataTyped(data ...Platform) Platform {
	if len(data) > 0 {
		return typedFrom[Platform](e.Data(asMap(data[0])))
	}
	return typedFrom[Platform](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Platform (all fields
// optional at the wire level).
func (e *PlatformEntity) MatchTyped(match ...Platform) Platform {
	if len(match) > 0 {
		return typedFrom[Platform](e.Match(asMap(match[0])))
	}
	return typedFrom[Platform](e.Match())
}
...
func (e *PlatformEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PlatformEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PlatformLoadMatch and returns an Platform. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PlatformEntity) LoadTyped(reqmatch PlatformLoadMatch, ctrl map[string]any) (Platform, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Platform{}, err
	}
	return typedFrom[Platform](res), nil
}



func (e *PlatformEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *PlatformEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PlatformEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PlatformEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PlatformEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
