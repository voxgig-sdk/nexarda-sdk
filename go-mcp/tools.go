...
func registerTools(server *mcp.Server, client *sdk.NexardaSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "nexarda_list",
		Description: "List records from Nexarda. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "nexarda_load",
		Description: "Load a single record from Nexarda. " +
...
func runOp(client *sdk.NexardaSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.NexardaSDK, name string) (sdk.NexardaEntity, error) {
	...
	case "platform":
		return client.Platform(nil), nil
	case "price":
		return client.Price(nil), nil
	case "retailer":
		return client.Retailer(nil), nil
	case "search":
		return client.Search(nil), nil
	case "studio":
		return client.Studio(nil), nil
	case "user":
		return client.User(nil), nil
	case "widget":
		return client.Widget(nil), nil
