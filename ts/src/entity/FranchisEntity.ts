...
class FranchisEntity extends NexardaEntityBase<Franchis> {
  ...
  async load(this: any, reqmatch?: FranchisLoadMatch, ctrl?: Control): Promise<Franchis> {
  ...
  async list(this: any, reqmatch?: FranchisListMatch, ctrl?: Control): Promise<Franchis[]> {
