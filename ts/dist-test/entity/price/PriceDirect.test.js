...
(0, node_test_1.describe)('PriceDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-price', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-price', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["game01"]))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NEXARDA_TEST_PRICE_ENTID'];
...
//# sourceMappingURL=PriceDirect.test.js.map