...
(0, node_test_1.describe)('StudioDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-studio', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-studio', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-studio', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-studio', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.NEXARDA_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NEXARDA_TEST_STUDIO_ENTID'];
    ...
    const client = new __1.NexardaSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=StudioDirect.test.js.map