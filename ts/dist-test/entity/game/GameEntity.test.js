...
function basicSetup(extra) {
    ...
    let idmap = transform(['game01', 'game02', 'game03', 'platform01', 'platform02', 'platform03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
