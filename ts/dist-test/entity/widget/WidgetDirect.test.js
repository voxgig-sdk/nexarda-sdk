...
(0, node_test_1.describe)('WidgetDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-widget', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-widget', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NEXARDA_TEST_WIDGET_ENTID'];
...
//# sourceMappingURL=WidgetDirect.test.js.map