...
(0, node_test_1.describe)('RetailerEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/retailer/RetailerTestData.json');
    ...
    let idmap = transform(['retailer01', 'retailer02', 'retailer03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=RetailerEntity.test.js.map