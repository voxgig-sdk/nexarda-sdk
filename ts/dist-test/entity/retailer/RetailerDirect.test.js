...
(0, node_test_1.describe)('RetailerDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-retailer', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-retailer', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NEXARDA_TEST_RETAILER_ENTID'];
...
//# sourceMappingURL=RetailerDirect.test.js.map