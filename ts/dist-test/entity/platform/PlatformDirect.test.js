...
(0, node_test_1.describe)('PlatformDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-platform', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-platform', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['NEXARDA_TEST_PLATFORM_ENTID'];
...
//# sourceMappingURL=PlatformDirect.test.js.map