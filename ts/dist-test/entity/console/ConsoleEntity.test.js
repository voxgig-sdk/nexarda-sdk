...
(0, node_test_1.describe)('ConsoleEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(console_ref01_data_dt0.id === console_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/console/ConsoleTestData.json');
    ...
    let idmap = transform(['console01', 'console02', 'console03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=ConsoleEntity.test.js.map