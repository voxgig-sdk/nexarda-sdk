...
(0, node_test_1.describe)('FranchisEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(franchis_ref01_data_dt0.id === franchis_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/franchis/FranchisTestData.json');
    ...
    let idmap = transform(['franchis01', 'franchis02', 'franchis03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=FranchisEntity.test.js.map