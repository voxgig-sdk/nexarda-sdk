...
function envOverride(m) {
    if ('TRUE' === process.env.NEXARDA_TEST_LIVE ||
        'TRUE' === process.env.NEXARDA_TEST_OVERRIDE) {
    ...
    m.NEXARDA_TEST_EXPLAIN = process.env.NEXARDA_TEST_EXPLAIN || m.NEXARDA_TEST_EXPLAIN;
    return m;
}
