...
class RetailerEntity extends NexardaEntityBase_1.NexardaEntityBase {
    ...
    make() {
        return new RetailerEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Retailer[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.RetailerEntity = RetailerEntity;
//# sourceMappingURL=RetailerEntity.js.map