...
const RetailerEntity_1 = require("./entity/RetailerEntity");
const SearchEntity_1 = require("./entity/SearchEntity");
const StudioEntity_1 = require("./entity/StudioEntity");
const UserEntity_1 = require("./entity/UserEntity");
const WidgetEntity_1 = require("./entity/WidgetEntity");
const node_util_1 = require("node:util");
const Config_1 = require("./Config");
Object.defineProperty(exports, "config", { enumerable: true, get: function () { return Config_1.config; } });
const NexardaEntityBase_1 = require("./NexardaEntityBase");
Object.defineProperty(exports, "NexardaEntityBase", { enumerable: true, get: function () { return NexardaEntityBase_1.NexardaEntityBase; } });
...
class NexardaSDK {
    ...
    async graphql(query, variables, ctrl) {
        ...
        if (null != errors && Array.isArray(errors) && 0 < errors.length) {
            ...
            const err = new Error('NexardaSDK: graphql: ' +
    ...
    Platform(entopts) {
        const self = this;
        return new PlatformEntity_1.PlatformEntity(self, entopts);
    }
    ...
    Retailer(entopts) {
        const self = this;
        return new RetailerEntity_1.RetailerEntity(self, entopts);
    }
    ...
    Studio(entopts) {
        const self = this;
        return new StudioEntity_1.StudioEntity(self, entopts);
    }
    ...
    Widget(entopts) {
        const self = this;
        return new WidgetEntity_1.WidgetEntity(self, entopts);
    }
...
exports.NexardaSDK = NexardaSDK;
const SDK = NexardaSDK;
exports.SDK = SDK;
//# sourceMappingURL=NexardaSDK.js.map